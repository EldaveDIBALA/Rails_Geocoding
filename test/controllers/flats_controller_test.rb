...
class FlatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flat" do
    assert_difference("Flat.count") do
      post flats_url, params: { flat: { address: @flat.address, available: @flat.available, description: @flat.description, listed_at: @flat.listed_at, name: @flat.name, price: @flat.price, rooms: @flat.rooms } }
    end
  ...
  test "should update flat" do
    patch flat_url(@flat), params: { flat: { address: @flat.address, available: @flat.available, description: @flat.description, listed_at: @flat.listed_at, name: @flat.name, price: @flat.price, rooms: @flat.rooms } }

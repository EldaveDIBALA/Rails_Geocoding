class FlatsController < ApplicationController
  ...
  def index
    ...
    # La scope 'geocoded' ne filtre seulement que les flats avec coordonées GPS
  ...
  private
    ...
    def flat_params
      params.require(:flat).permit(:name, :address, :description, :price, :rooms, :available, :listed_at)
    end
end
